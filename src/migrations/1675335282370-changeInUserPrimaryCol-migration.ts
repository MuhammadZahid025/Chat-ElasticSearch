...
export class changeInUserPrimaryColMigration1675335282370 implements MigrationInterface {
    name = 'changeInUserPrimaryColMigration1675335282370'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "messages" ADD "authorId" uuid`);
